      ...
      <div className="flex justify-center py-[60px]">
        ...
        <div className="w-[40%]">
          ...
          <div className="text-[20px] flex items-center gap-1">
            ...
            {clientRating}
            {/* <IoMdStarOutline /> */}
            <span className='font-dm font-normal text-[#767676] text-[14px]'> 1 Reviews</span>
          </div>
          <ToastContainer
            position="top-center"
            autoClose={5000}
          ...
          />
          <div className="mt-5">
            <a className="py-5 px-10 bg-[#262626] text-white inline-block mr-3">Add To Wishlist</a>
            <a onClick={handleCart} className="py-5 px-10 bg-[#262626] text-white inline-block">Add To Cart</a>
          </div>
        </div>
      </div>
    </Container>
